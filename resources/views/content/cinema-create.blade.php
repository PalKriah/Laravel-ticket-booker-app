...
<div class="row justify-content-center">
    <div class="col-md-8">
        <h1><span class="header-underline">{{ __('Add Cinema') }}</span></h1>
        <form action="{{ route('cinemas.insert') }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control @error('cinema.country') is-invalid @enderror" type="text"
                    name="cinema[country]" value="{{ old('cinema.country') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control @error('cinema.city') is-invalid @enderror" type="text"
                    name="cinema[city]" value="{{ old('cinema.city') }}">
                @error('cinema.city')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group">
                ...
                <input class="form-control @error('cinema.location') is-invalid @enderror" type="text"
                    name="cinema[location]" value="{{ old('cinema.location') }}">
