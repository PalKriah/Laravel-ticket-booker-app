...
<div class="row justify-content-center">
    <div class="col-md-8">
        <h1><span class="header-underline">{{ __('Add Movie') }}</span></h1>
        <form action="{{ route('movies.insert') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('movie.description') is-invalid @enderror" type="text"
                    name="movie[description]">{{ old('movie.description') }}</textarea>
